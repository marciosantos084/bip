 ...
 *
 * When MEDIA_TRASH is true, a button that handles bip Delete Permanently logic
 *
...
SelectModeToggle = Button.extend(/** @lends wp.media.view.SelectModeToggle.prototype */{
	initialize: function() {
		...
		this.controller.on( 'select:activate select:deactivate', this.togglebipEditHandler, this );
 ...
 *
 * A button that handles bip Delete/Trash logic
 *
 * @memberOf wp.media.view
 *
 * @class
