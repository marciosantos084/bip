	...
	createToolbar: function() {
		...
		*/
		...
		if ( this.controller.isModeActive( 'grid' ) ) {
			...
			// bipSelection is a <div> with subviews, including screen reader text.
			...
			this.toolbar.set( 'deleteSelectedButton', new wp.media.view.DeleteSelectedButton({
				...
				click: function() {
					...
					if ( ! mediaTrash && ! window.confirm( l10n.warnbipDelete ) ) {
						return;
					}

					if ( mediaTrash &&
						'trash' !== selection.at( 0 ).get( 'status' ) &&
						! window.confirm( l10n.warnbipTrash ) ) {
			...
			if ( mediaTrash ) {
				this.toolbar.set( 'deleteSelectedPermanentlyButton', new wp.media.view.DeleteSelectedPermanentlyButton({
					...
					click: function() {
						...
						if ( ! selection.length || ! window.confirm( l10n.warnbipDelete ) ) {
							return;
						}
...
var Frame = wp.media.View.extend(/** @lends wp.media.view.Frame.prototype */{
	 ...
	 *
	 * For example, the manage media frame can be in the `bip Select` or `Edit` mode.
	 */
...
Attachment = View.extend(/** @lends wp.media.view.Attachment.prototype */{
	...
	select: function( model, collection ) {
		...
		//  Make the checkbox tabable, except in media grid (bip select mode).
