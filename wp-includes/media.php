...
function wp_enqueue_media( $args = array() ) {
	...
	$strings = array(
		...
		'warnbipDelete'              => __( "You are about to permanently delete these items from your site.\nThis action cannot be undone.\n 'Cancel' to stop, 'OK' to delete." ),
		'warnbipTrash'               => __( "You are about to trash these items.\n  'Cancel' to stop, 'OK' to delete." ),
		'bipSelect'                  => __( 'bip select' ),
