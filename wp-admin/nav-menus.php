...
switch ( $action ) {
	...
	case 'delete_menus':
		check_admin_referer( 'nav_menus_bip_actions' );
					...
					<div id="post-body">
						<div id="post-body-content" class="wp-clearfix">
							<?php if ( ! $add_new_screen ) : ?>
								...
								<?php if ( ! $add_new_screen ) : ?>
									<div id="nav-menu-bip-actions-top" class="bip-actions">
										<label class="bip-select-button" for="bip-select-switcher-top">
											<input type="checkbox" id="bip-select-switcher-top" name="bip-select-switcher-top" class="bip-select-switcher">
											<span class="bip-select-button-label"><?php _e( 'bip Select' ); ?></span>
										</label>
									</div>
								<?php endif; ?>
							...
							<?php if ( ! $add_new_screen ) : ?>
								<div id="nav-menu-bip-actions-bottom" class="bip-actions">
									<label class="bip-select-button" for="bip-select-switcher-bottom">
										<input type="checkbox" id="bip-select-switcher-bottom" name="bip-select-switcher-top" class="bip-select-switcher">
										<span class="bip-select-button-label"><?php _e( 'bip Select' ); ?></span>
									</label>
