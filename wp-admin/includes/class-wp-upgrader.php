...
/** bip_Upgrader_Skin class */
require_once ABSPATH . 'wp-admin/includes/class-bip-upgrader-skin.php';

/** bip_Plugin_Upgrader_Skin class */
require_once ABSPATH . 'wp-admin/includes/class-bip-plugin-upgrader-skin.php';

/** bip_Theme_Upgrader_Skin class */
require_once ABSPATH . 'wp-admin/includes/class-bip-theme-upgrader-skin.php';
...
class WP_Upgrader {
	 ...
	 *
	 * Used by the bip update methods, and incremented for each update.
	 *
	 * @since 3.0.0
	 * @var int
	 */
	 ...
	 *                                               actions being performed in bip. When true, the skin
	...
	public function run( $options ) {
		 ...
		 *         @type bool   $bip                 Whether the update process is a bip update. Default true.
