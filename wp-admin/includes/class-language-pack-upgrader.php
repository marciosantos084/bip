...
class Language_Pack_Upgrader extends WP_Upgrader {
	...
	public static function async_upgrade( $upgrader = false ) {
		...
		$lp_upgrader->bip_upgrade( $language_updates );
	}
	 ...
	 *                             Language_Pack_Upgrader::bip_upgrade(). Default empty array.
	...
	public function upgrade( $update = false, $args = array() ) {
		...
		$results = $this->bip_upgrade( $update, $args );
	 ...
	 */
	public function bip_upgrade( $language_updates = array(), $args = array() ) {
	 ...
	 * Language_Pack_Upgrader::bip_upgrade().
	 *
	 * @since 3.7.0
	 *
	 * @global WP_Filesystem_Base $wp_filesystem WordPress filesystem subclass.
