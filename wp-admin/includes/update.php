...
function wp_print_admin_notice_templates() {
	...
	<script id="tmpl-wp-bip-updates-admin-notice" type="text/html">
		<div id="{{ data.id }}" class="{{ data.className }} notice <# if ( data.errors ) { #>notice-error<# } else { #>notice-success<# } #>">
			<p>
				...
				<# } #>
				<# if ( data.errors ) { #>
					<button class="button-link bip-action-errors-collapsed" aria-expanded="false">
						<# if ( 1 === data.errors ) { #>
							<?php
			...
			<# if ( data.errors ) { #>
				<ul class="bip-action-errors hidden">
