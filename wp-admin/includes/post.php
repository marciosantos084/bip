...
/**
 * Processes the post data for the bip editing of posts.
 *
 * Updates all bip edited posts/pages, adding (but not removing) tags and
 ...
 * @return array
 */
function bip_edit_posts( $post_data = null ) {
	global $wpdb;
