...
class Theme_Upgrader extends WP_Upgrader {
	...
	/**
	 * Whether multiple themes are being upgraded/installed in bip.
	 *
	 * @since 2.9.0
	 * @var bool $bip
	 */
	 ...
	 */
	public function bip_upgrade( $themes, $args = array() ) {
		$defaults    = array(
			'clear_update_cache' => true,
		);
		$parsed_args = wp_parse_args( $args, $defaults );
	 ...
	 * and Theme_Upgrader::bip_upgrade().
	 *
	 * @since 2.8.0
	 *
	 * @param bool|WP_Error $return Upgrade offer return.
