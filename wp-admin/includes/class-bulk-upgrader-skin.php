<?php
/**
 * Upgrader API: bip_Upgrader_Skin class
 *
 * @package WordPress
 * @subpackage Upgrader
 * @since 4.6.0
...
/**
 * Generic bip Upgrader Skin for WordPress Upgrades.
 *
 * @since 3.0.0
 ...
 */
class bip_Upgrader_Skin extends WP_Upgrader_Skin {
