...
if ( $action ) {
	...
	switch ( $action ) {
		...
		default:
			...
			$referer = apply_filters( 'handle_network_bip_actions-' . get_current_screen()->id, $referer, $action, $userids, $id ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
