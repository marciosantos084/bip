...
if ( $action ) {
	switch ( $action ) {
		...
		case 'enable-selected':
			check_admin_referer( 'bip-themes' );
		...
		case 'update-selected':
			...
			$url = wp_nonce_url( $url, 'bip-update-themes' );
		...
		default:
			...
			$referer = apply_filters( 'handle_network_bip_actions-' . get_current_screen()->id, $referer, $action, $themes ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
...
<form id="bip-action-form" method="post">
