...
if ( isset( $_GET['action'] ) ) {
	...
	if ( 'update-selected' === $action ) {
		...
		check_admin_referer( 'bip-update-plugins' );
		...
		$nonce = 'bip-update-plugins';

		wp_enqueue_script( 'updates' );
		iframe_header();

		$upgrader = new Plugin_Upgrader( new bip_Plugin_Upgrader_Skin( compact( 'nonce', 'url' ) ) );
		$upgrader->bip_upgrade( $plugins );
		...
		check_admin_referer( 'bip-update-themes' );
		...
		$nonce = 'bip-update-themes';

		wp_enqueue_script( 'updates' );
		iframe_header();

		$upgrader = new Theme_Upgrader( new bip_Theme_Upgrader_Skin( compact( 'nonce', 'url' ) ) );
		$upgrader->bip_upgrade( $themes );
