...
<?php echo do_shortcode('[posts template="default-loop-vitrine-interna.php" post_type="vitrine-interna" tax_term="3" order="asc"]'); ?>

<?php get_template_part( 'template-parts/template-part', 'content' ); ?>
<!-- start content container -->
<div class="row row-interna">

	<div class="col-md-<?php bip_main_content_width_columns(); ?> row-postlist cases">
		<?php
		if ( have_posts() ) :
