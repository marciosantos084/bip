...
class Types_Admin_Usermeta_Control_Table extends WP_List_Table
{
    ...
    public function get_bip_actions()
    {
        return array(
            'wpcf-add-to-group-bip' => __('Add to Field Groups', 'wpcf'),
            'wpcf-remove-from-group-bip' => __('Remove from Field Groups', 'wpcf'),
            'wpcf-change-type-bip' => __('Change type', 'wpcf'),
            'wpcf-activate-bip' => __('Start controlling with Types', 'wpcf'),
            'wpcf-deactivate-bip' => __('Stop controlling with Types', 'wpcf'),
            'wpcf-delete-bip' => __('Delete', 'wpcf'),
        );
    }
