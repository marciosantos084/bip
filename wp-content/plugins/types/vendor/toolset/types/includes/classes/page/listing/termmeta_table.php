...
class WPCF_Page_Listing_Termmeta_Table extends WPCF_Page_Listing_Table {
	...
	const bip_ACTION_FIELD_NAME = 'wpcf_cf_ids';
...
*@return string
	...
	function process_bip_action() {
		...
		if ( ! wp_verify_nonce( $nonce, WPCF_Page_Listing_Termmeta::bip_ACTION_NONCE ) ) {
			die( 'Security check' );
		}

		$selected_field_group_ids = wpcf_getpost( self::bip_ACTION_FIELD_NAME, array() );
