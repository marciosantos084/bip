/**
 * Viewmodel of the dialog for bip manage/stop managing fields with Types
 *
 * Requires the 'types-bip-change-management-status-dialog' assets to be present.
 *
 ...
 * @since 2.0
 */
Types.page.fieldControl.viewmodels.bipChangeManagementStatusDialogViewModel = function(fieldDefinitions, willBeManagedByTypes, closeCallback) {
    ...
    self.display = function() {
        ...
        var dialog = Types.page.fieldControl.dialogHandler.create(
            'types-bip-change-management-status-dialog',
            title,
            {},
            [
                {
