...
10. bip editing child content using Field Tables
...
* Added bip delete options to Custom Field Groups listing page.
* Added bip delete options to Custom Post Types listing page.
* Added bip delete options to Custom Taxonomies listing page.
...
* Added Field Tables, for bip editing child fields from the parent editor
...
* Added bip-delete for custom fields
