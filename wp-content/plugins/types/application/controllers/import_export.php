...
final class Types_Import_Export {
	 ...
	 * @param bool $bip_overwrite_groups If true, all (conflicting) groups will be overwritten by the ones from import.
	...
	public function process_field_group_import_per_domain(
		...
		foreach ( $groups_import_data as $group ) {
			...
			if ( $group_should_be_imported ) {
				if ( $bip_overwrite_groups                          // bip overwrite (types import/export page)
				     || (                                            // OR...
