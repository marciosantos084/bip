  ...
  function output_formtaxo_fields($type,$exc,$hide,$taxname,$taxlabel,$taxall,$opt,$c,$defaultclass,$formid,$divclass){
		...
		$taxoargs = apply_filters('uwpqsf_taxonomy_arg',$args,$taxname,$formid);
		 ...
		 if($type == 'dropdown'){
			...
			$html .=  '<svg version="1.1" id="Isolation_Mode" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
...
<select id="tdp-'.$c.'" class="tdp-class-'.$c.'" name="taxo['.$c.'][term]">'; 
			if(!empty($taxall)){
